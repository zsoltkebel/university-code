...
class SmartBin:
    ...
    def __init__(self, cap, irs, uss, **kwargs):
        super().__init__(**kwargs)
        self.infra_red_sensor = irs
        self.ultra_sonic_sensor = uss
        self._capacity = cap
        self._fill_level = 0
    ...
    def update_fill_level(self):
        ...
        self._fill_level = (100 - self.ultra_sonic_sensor.get_distance()) / 100


bin = SmartBin(cap=500,
               irs=InfraRedSensor(mot=30, ty="Passive", ra=300, acc=1.0, sid="abc1234"),
               uss=UltraSonicSensor(freq=400.2, ra=300, acc=1.0, sid="abc1234"))
